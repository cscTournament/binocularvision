package by.gourianova.binocularvision.util.tetris.ui;

import by.gourianova.binocularvision.util.tetris.model.Coordinates;
import by.gourianova.binocularvision.util.tetris.service.PlayFigure;
...
public class Window extends JFrame implements Runnable {
    private final by.gourianova.binocularvision.util.tetris.ui.Box[][] boxes;
    ...
    public by.gourianova.binocularvision.util.tetris.ui.Box[][] getBoxes() {
        return boxes;
    }

    public Window() {
        boxes = new by.gourianova.binocularvision.util.tetris.ui.Box[Config.WIDTH][Config.HEIGHT];
        initForm();
        initBoxes();
    ...
    public void initBoxes() {
        for (int x = 0; x < Config.WIDTH; x++) {
            for (int y = 0; y < Config.HEIGHT; y++) {
                boxes[x][y] = new by.gourianova.binocularvision.util.tetris.ui.Box(x, y);
                add(boxes[x][y]);
            }
        }
    }
